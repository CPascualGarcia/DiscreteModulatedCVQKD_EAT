...
% for our paper with a heterodyne setup
% IN
...
fprintf('Region operators for the key map defined \n');
...
% coefficients called gammaRaw, while the gammaBars will define the same 
